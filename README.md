# 迷梦 Live2D AI Android Test

一个围绕“迷梦 Live2D 模型 + DeepSeek V4 Flash High + Android App”制作的专用测试项目。
...
- Android App 内通过 WebView/WebGL 渲染迷梦模型
...
- 11 种基础情绪和 8 种对话动作；9 种程序情绪保留增强幅度，疑惑和害羞使用原始幅度，害羞额外启用模型作者的脸红参数
...
1. 安装 GitHub Actions 生成的 v0.3.3-test debug APK。
